...
SELECT id, amount, from_account_id, to_account_id, created_at FROM transfers WHERE id = $1
`
...
SELECT id, amount, from_account_id, to_account_id, created_at FROM transfers WHERE 
